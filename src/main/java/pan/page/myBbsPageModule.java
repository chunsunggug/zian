...
public class myBbsPageModule {

	public static String makePage(String pagename,String id, int totalCnt, int listSize, int pageSize, int cp) {   //사용할 페이지 이름, 총게시물 수, 리스트 사이즈, 페이지 사이즈 , 현재 위치 페이지
